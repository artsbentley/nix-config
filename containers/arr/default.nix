...
in
{
  ...
  system.activationScripts.recyclarr_configure = ''
    	...
    	$sed -i "s/# - 9b64dff695c2115facf1b6ea59c9bd07 # x265 (no HDR/DV)/- 9b64dff695c2115facf1b6ea59c9bd07 # x265 (no HDR/DV)/" $tempSonarr
    	...
    	$sed -i "s/# - 839bea857ed2c0a8e084f3cbdbd65ecb # x265 (no HDR/DV)/- 839bea857ed2c0a8e084f3cbdbd65ecb # x265 (no HDR/DV)/" $tempRadarr
