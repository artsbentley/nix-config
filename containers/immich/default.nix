...
let
  directories = [
    ...
    "${vars.nasMount}/Photos"
    "${vars.nasMount}/Photos/Immich"
  ];
in
{
  ...
  virtualisation.oci-containers.containers = {
    immich = {
      ...
      volumes = [
        ...
        "${vars.nasMount}/Photos/Immich:/photos"
        "${vars.nasMount}/Photos/S10m:/import:ro"
        "${vars.serviceConfigRoot}/immich/machine-learning:/config/machine-learning"
      ];
      environmentFiles = [ config.age.secrets.immichDatabase.path ];
      environment = {
        PUID = "994";
        PGID = "993";
        TZ = "Europe/Berlin";
